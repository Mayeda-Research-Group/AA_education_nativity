...
fig_nativity_cox <- ggplot(
  ...
  theme_bw() +
  ylab("Hazard ratio for dementia incidence \n(college degree or higher versus less than college degree)") + # updated on 07/17/2022
...
fig_nativity_aalen <- ggplot(
  ...
  theme_bw() +
  ylab("Hazard difference for dementia cases (per 1,000 person-years) \n(college degree or higher versus less than college degree)") + # updated on 07/17/2022
...
#save the result
ggsave(paste0(path_to_figures, "Education_nativity_cox_2022_04_18_v4.png"), plot = fig_nativity_cox, width = 20, height = 12, units = "cm")
ggsave(paste0(path_to_figures, "Education_nativity_aalen_2022_04_18_v4.png"), plot = fig_nativity_aalen, width = 20, height = 12, units = "cm")
